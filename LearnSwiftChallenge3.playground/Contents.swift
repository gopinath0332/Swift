...
class Library {
    ...
    func searchByTitle(_ title:String) -> String {
        ...
        if(bookId != nil){
            if checkedOutBooks.index(forKey: bookId!) != nil{
    ...
    func checkOut(_ bookId:String, _ person:Person) -> String {
        ...
        let isBookExist = catalogue.index(forKey: bookId)
        if(isBookExist != nil){
            let index = checkedOutBooks.index(forKey: bookId)
            if index == nil{
                checkedOutBooks[bookId] = person
                return "Successfully checked out"
            }else{
                return "Error: Book '\(bookId)' already checked out"
            }
        }else{
    ...
    func checkIn(_ bookId:String) -> String {
        ...
        let isBookExist = catalogue.index(forKey: bookId)
        if isBookExist != nil{
            let isBookCheckedIn = checkedOutBooks.index(forKey: bookId);
            if(isBookCheckedIn != nil){
